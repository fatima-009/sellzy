...
const [active, setActive] = useState("All Products");
  ...
  return (
    ...
    <main className='bg-[var(--backgroundColor)] text-black'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 py-10 space-y-2'>
                    {[
                       ...
                       <div key={index} className='mx-3 py-3 bg-white rounded-2xl border border-gray-300'>
                        ...
                        src={item.img} 
                        alt="" 
                        className='w-65 h-60 object-cover rounded-xl mx-auto cursor-pointer bg-pink-100'/>
        ...
        <section className="grid grid-cols-2 md:grid-cols-6 mx-12 gap-12 py-7">
            <div>
                <img 
                ...
                {[
                    ...
                    },
                    {
                       ...
                       <div key={index} className='mx-3 py-3 bg-white rounded-2xl'>
                        ...
                        src={item.img} 
                        alt="" 
                        className='w-65 h-65 object-cover rounded-xl mx-auto cursor-pointer bg-pink-100'/>
                        </div>
